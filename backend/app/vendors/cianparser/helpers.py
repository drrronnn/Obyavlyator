...
def define_specification_data(block):
    ...
    specification_data["home_type"] =  "flat"
    ...
    specification_data["rooms_count"], specification_data["home_type"] = define_rooms_count(common_properties)
